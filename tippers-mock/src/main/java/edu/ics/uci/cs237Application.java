...
import edu.ics.uci.resources.MockTIPPERSResource;
...
public class cs237Application extends Application<cs237Configuration> {
    ...
    public void run(final cs237Configuration configuration,
        ...
        final MockTIPPERSResource mockTIPPERSResource = new MockTIPPERSResource();
        environment.jersey().register(mockTIPPERSResource);
    }
